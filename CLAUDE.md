...
- **Small, targeted fixes** (1-3 files, <50 lines): 1-2 sentences
- **Medium changes** (3-5 files, 50-200 lines): 1-2 short paragraphs
- **Large features** (5+ files, 200+ lines): Up to 4 paragraphs or lists
